...
import {FiBold, FiChevronUp, FiCode, FiCommand, FiDownload, FiHeadphones, FiSmartphone} from "react-icons/fi";
import {
    Accordion,
    AccordionItem,
    AccordionItemButton,
        ...
        return (
            <Fragment>
                            ...
                            <div className="row">
                                <div className="col-lg-8 col-xl-5">
                                    <div className="inner">
                                        ...
                                        <p className="title">Welcome to TryDO React Creative Agency, React Portfolio and
                                            Corporate Multi Purpose Template Built With React JS. NO jQuery!</p>
                                        <div className="purshase-btn">
                                            ...
                                            <a href="#demo"
                                               className="rn-button-style--2 btn-border rn-btn-dark border-opacity-half">View
                                                Demos</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="main-wrapper" id="demo">
                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="section-title text-center pb--30">
                                        ...
                                        <p>Choose one of styles or cutomize easily your site following your
                                            ideas. <br/> More
                                        ...
                                        <div key={index} className="col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div className="single-demo">
                                                <a target="_blank" rel="noopener noreferrer" href={`/${value.url} `}>
                                                    <img src={`/assets/images/preview/${value.imageUrl}`}
                                                         alt="Creative Agency Images"/>
                                                    <h3 className="title">{value.title}</h3>
                                                    <p className="info">{value.description}</p>
                                                    {value.label ? <div className="label-new"><span>{value.label}</span>
                                                    </div> : ''}
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div className="faq-area">
                                        <Accordion className="accodion-style--1" preExpanded={'0'}>
                                            <AccordionItem>
                                                ...
                                                <AccordionItemPanel>
                                                    <p>Welcome to TryDO React Creative Agency, React Portfolio and
                                                        Corporate Multi Purpose Template Built With React JS. NO
                                                        jQuery!. It works too much faster loading speed and you can
                                                        works too much comfortability.Trydo create your website so much
                                            ...
                                            <AccordionItem>
                                                ...
                                                <AccordionItemPanel>
                                                    <p>You can run trydo easily.
                                                        ...
                                                        So Please open your command prompt then check your node -v and
                                                        npm -v Version.
                                                        Goes To Your your command prompt: then
                                                        First: <strong>npm install</strong></p>
                                                    <p>At Last: <strong>npm run start</strong>. By the following way you
                                                        can be run your project easily.</p>
                                                </AccordionItemPanel>
                                            </AccordionItem>
                                                ...
                                                <AccordionItemPanel>
                                                    <div>
                                                        <p>
                                                            ...
                                                            http://localhost:3000 you can showing any page as your you
                                                            are like. First you have to go index.js page then:
                                                        </p>
                                                        <p>First Step (replace your choose demo page): Example: import
                                                            Demo form './home/MainDemo' Instead of
                                                            './home/PortfolioLanding'</p>
                                                        <p>Example: <a className="theme-gradient"
                                                                       href="https://www.dropbox.com/s/ysornwsweh836wi/change-home-page.png?dl=0">https://www.dropbox.com/s/ysornwsweh836wi/change-home-page.png?dl=0</a>
                                                        </p>
                                                    </div>
                                                </AccordionItemPanel>
                                            </AccordionItem>
                                            ...
                                            <AccordionItem>
                                                ...
                                                <AccordionItemPanel>
                                                    <p>
                                                        ...
                                                        share with us with sending mail to <a className="theme-gradient"
                                            ...
                                            <AccordionItem>
                                                ...
                                                <AccordionItemPanel>
                                                    <p>
                                                        Yes, We will get update the Trydo. And you can get it any time.
                                                        Next time we will comes with more feature.
                                                        You can be get update for unlimited times. Our dedicated team
                                                        works for update.
                                                    </p>
                                                </AccordionItemPanel>
                                            </AccordionItem>
                                            ...
                                            <AccordionItem>
                                                ...
                                                <AccordionItemPanel>
                                                    <p>
                                                        Yes, You can change any component as you like. And By the way
                                                        you can build your website which you are choose.
                                                    </p>
                                                </AccordionItemPanel>
                                            </AccordionItem>
                    ...
                    {/* Start Footer Area  */}
                    <footer
                        className="call-to-action-wrapper text-white-wrapper call-to-action ptb--120 with-particles">
