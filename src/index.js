...
import BlogDetailsPapillon from "./elements/BlogDetailsPapillon";
import BlogDetailsPersonnalise from "./elements/BlogDetailsPersonnalise";
            ...
            <BrowserRouter basename={'/'}>
                <PageScrollTop>
                    <Switch>
                        ...
                        <Route exact path={`${process.env.PUBLIC_URL}/papillon`} component={BlogDetailsPapillon}/>
                        <Route exact path={`${process.env.PUBLIC_URL}/jewel`} component={BlogDetails}/>
                        <Route exact path={`${process.env.PUBLIC_URL}/perso`} component={BlogDetailsPersonnalise}/>
