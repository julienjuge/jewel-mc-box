...
const TabOne = [
    {
        image: '01',
        bigImage: '/assets/images/jewel1.jpeg',
    },
    {
        image: '02',
        bigImage: '/assets/images/JEWEL2.jpeg',
    },
    {
        image: '03',
        bigImage: '/assets/images/JEWEL3.jpeg',
    }
]
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <div className="inner-wrapper">
                                    <div className="inner">
                                        <p>Ce modèle peut être décliné en support publicitaire total ou partiel</p>
                                        ...
                                        <div className="video-wrapper position-relative mb--40">
                                            <div className="thumbnail">
                                                <img src="/assets/images/JEWEL3.jpeg" alt="Blog Images"/>
                                            </div>
